...
namespace Vlm
{
    [AddComponentMenu("BallisticNG/Rendering/Lightmapping Options")]
    public class VlmBakeOptionsComponent : MonoBehaviour
    {
        ...
        /// <summary>
        /// Loads settings from an older lightmapping options component.
        /// </summary>
        /// <param name="options"></param>
        public void ConvertFromOldOptions(LightmappingOptions options)
        {
            BakeOptions.WorldUpShadows = !options.AllowDirectionalShadows;
            BakeOptions.CastShadows = options.CastShadows;
            BakeOptions.RecieveShadows = options.RecieveShadows;
            IgnoreLightmapper = options.IgnoreLightmapper;
        }
