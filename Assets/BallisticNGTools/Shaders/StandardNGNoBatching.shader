Shader "Standard (BallisticNG - No Batching)"
{
	Properties
	{
		/*---Textures---*/
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f vert(appdata_full v)
				{
					...
					/*---Distance To Camera---*/
					o.distance.x = GetClippingDistance(v.vertex, 0.3, _VertexSnapping);
	...
	CustomEditor "BallisticUnityTools.Editor.Shaders.StandardNgShaderEditor"
}