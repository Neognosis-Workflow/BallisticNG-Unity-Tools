Shader "BallisticNG/Terrain/Terrain Advanced Max"
{
    Properties
    {
		...
		_Texture1("Green Diffuse", 2D) = "black" {}
		...
		_Texture3("Alpha Diffuse", 2D) = "black" {}
	...
	Fallback "BallisticNG/DepthOpaqueCull"
}
